  ...
  return (
    <section className="mb-16 max-w-[1280px] mx-auto">
      <div className="flex flex-col items-center gap-2 text-center">
        <h2 className="font-serif font-bold text-[96px] mb-3 text-headline">
          {t("investments.title")}
        </h2>

        <p className="font-sans text-[24px] text-headline">
          {t("investments.subtitle")}
        </p>

        <p className="font-sans text-[20px] leading-[32px] text-text">
          {t("investments.desc")}
        </p>
